...
import { FaMoneyBillWave, FaArrowLeft, FaSave, FaTag, FaPercentage, FaCheck, FaTimes, FaShieldAlt, FaCogs, FaCoins, FaHistory, FaChevronDown } from 'react-icons/fa';
...
export default function Create() {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        value_type: 'flat', // 'flat' or 'percentage'
        is_taxable: false,
        default_amount: '',
    });
            ...
            <div className="py-4 px-4 sm:px-6 lg:px-8 space-y-6">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-6 bg-white p-5 rounded-lg shadow-sm relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-4 relative z-10">
                        ...
                        <div>
                            <h2 className="text-xl font-normal text-slate-900 tracking-normal leading-none mb-2 uppercase tracking-normal">New Component</h2>
                    ...
                    <div className="space-y-6 sticky top-6">
                        ...
                        <div className="bg-slate-50 p-6 rounded-lg flex gap-4">
                            ...
                            <p className="text-[9px] font-normal text-slate-500 uppercase tracking-normal leading-relaxed">
                                ENSURE COMPONENT NAMES ARE UNIQUE TO AVOID CONFUSION.
                            </p>
                        </div>
                    </div>
                </form>
