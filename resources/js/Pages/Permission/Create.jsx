                ...
                <form onSubmit={handleSubmit} className="w-full mx-auto px-4 space-y-4">
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-3 flex justify-between items-center sticky top-4 z-20">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-xs font-normal text-slate-900 uppercase tracking-normal">Define Capability</h1>
                                <p className="text-[9px] text-slate-400 font-normal uppercase tracking-normal">Register a new granular system permission</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-2">
                            ...
                            >
                                {processing ? 'Registering...' : <><FaCheck /> Authorize & Create</>}
                            </button>
                        </div>
                    </div>
                                ...
                                <div className="p-4 space-y-4">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="space-y-1">
                                            ...
                                            <input
                                                ...
                                                placeholder="E.G. AUTHORIZE PAYROLL"
                                                required
                                            />
                                            {errors.name && <p className="text-[9px] text-rose-500 font-normal uppercase ml-1 mt-1">{errors.name}</p>}
                                        </div>
                                        <div className="space-y-1">
                                            <label className="text-[10px] font-normal text-slate-400 uppercase tracking-normal ml-1">Technical Slug</label>
                                            <input
                                                type="text"
                                                value={data.slug}
                                                onChange={(e) => setData('slug', e.target.value.toLowerCase().replace(/\s+/g, '-'))}
                                                className="w-full bg-slate-50 border-slate-200 rounded-lg text-xs font-mono font-normal text-slate-500 focus:ring-primary focus:border-primary placeholder:text-slate-300 uppercase tracking-normal"
                                                placeholder="authorize-payroll"
                                                required
                                            />
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <textarea
                                            ...
                                            placeholder="DEFINE THE EXACT SCOPE OF THIS PERMISSION..."
                                        />
                        ...
                        <div className="lg:col-span-4 space-y-4">
                                ...
                                <div className="p-4 space-y-4">
                                    ...
                                    <div className="p-3 bg-slate-50 rounded-lg border border-slate-100">
                                        <p className="text-[8px] text-slate-400 font-normal leading-relaxed uppercase">
                                            Slugs must be unique across the system. Once defined, permissions must be assigned to roles to become effective in user sessions.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-slate-900 rounded-lg shadow-xl p-6 text-center space-y-4 relative overflow-hidden group">
                                ...
                                <div className="relative z-10 space-y-3">
                                    ...
                                    <div>
                                        <h3 className="text-xs font-normal text-white uppercase tracking-normal truncate px-4">
                                            {data.name || 'NEW CAPABILITY'}
                                        </h3>
