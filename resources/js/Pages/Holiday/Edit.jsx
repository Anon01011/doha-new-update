...
import { FaCalendarAlt, FaBuilding, FaArrowLeft, FaSave, FaFileAlt, FaInfoCircle, FaClock, FaHistory, FaEdit, FaChevronDown } from 'react-icons/fa';

export default function Edit({ holiday, companies, auth }) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        company_ids: holiday.company_ids || (holiday.company_id ? [holiday.company_id] : []),
    ...
    return (
        <AuthenticatedLayout header={<h2 className="text-xl font-normal text-slate-800">Edit Holiday</h2>}>
            ...
            <div className="py-4 px-3 sm:px-4 lg:px-6 space-y-4">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-white p-4 rounded-xl border border-slate-200 shadow-sm relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-4 relative z-10">
                        ...
                        <div>
                            <h2 className="text-xl font-normal text-slate-900 leading-none mb-2">Edit Holiday</h2>
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                            <div className="p-6 md:p-8">
                                <form id="holiday-edit-form" onSubmit={handleSubmit} className="space-y-8">
                                    {/* Details */}
                                        ...
                                        {userRole === 'admin' ? (
                                            ...
                                            <div className="space-y-3 opacity-60">
                                                ...
                                                <div className="px-5 py-3 bg-slate-100 border border-slate-200 rounded-xl text-[11px] font-normal text-slate-400 cursor-not-allowed">
                                                    {companies.find(c => c.id === data.company_id)?.name || 'Local Entity'}
                                                </div>
                                            </div>
                                        )}
                                    </div>
                            ...
                            <ul className="space-y-6 relative z-10">
                                <li className="flex gap-4">
                                    ...
                                    <p className="text-[10px] font-normal text-slate-200 leading-relaxed">
                                        Changing <span className="text-white font-normal">Dates</span> will check for scheduling conflicts.
                                    </p>
                                </li>
                                <li className="flex gap-4">
                                    ...
                                    <p className="text-[10px] font-normal text-slate-200 leading-relaxed">
                                        All previously generated <span className="text-white font-normal">Holiday Pay</span> cycles may be recalculated upon commitment.
                                    </p>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between items-center py-3 border-b border-slate-50">
                                    <span className="text-[10px] font-normal text-slate-400">Created On</span>
                                    <span className="text-[11px] font-normal text-slate-900">{new Date(holiday.created_at).toLocaleDateString()}</span>
                                </div>
                                <div className="flex justify-between items-center py-3">
                                    <span className="text-[10px] font-normal text-slate-400">Sync State</span>
