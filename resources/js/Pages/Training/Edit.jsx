...
import { FaChalkboardTeacher, FaCalendarAlt, FaMapMarkerAlt, FaUsers, FaArrowLeft, FaSave, FaLayerGroup, FaShieldAlt, FaClock, FaInfoCircle, FaPlus } from 'react-icons/fa';
import { useState } from 'react';
import Modal from '@/Components/Modal';

export default function Edit({ training, companies, categories }) {
            ...
            <div className="p-4 space-y-4 bg-slate-50 min-h-screen">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-white p-4 rounded-lg border border-slate-200 shadow-sm">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-base font-normal text-slate-900">Edit Training</h2>
                            <p className="text-xs text-slate-400">Editing: {training.title}</p>
                        </div>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-start">
                    ...
                    <div className="space-y-4 sticky top-4">
                        ...
                        <div className="bg-white rounded-lg border border-slate-200 p-4 space-y-2 shadow-sm">
                            <h3 className="text-sm font-normal text-slate-800 flex items-center gap-2">
                                <FaInfoCircle className="text-amber-500" size={13} /> Training Status
                            </h3>
                            <select
                        ...
                        <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-5 space-y-4">
                            ...
                            {companies && companies.length > 1 && (
                                <div className="space-y-1">
                                    ...
                                    <select
                                        className="w-full px-3 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:ring-1 focus:ring-primary focus:border-primary outline-none"
                        ...
                        <div className="bg-slate-50 p-4 rounded-lg border border-slate-100 flex gap-3">
                            ...
                            <p className="text-xs text-slate-500 leading-relaxed">
                                Changes may affect existing enrollments and certificates.
                            </p>
                        </div>
                    </div>
                </form>
