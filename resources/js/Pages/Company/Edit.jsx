                    ...
                    <div className="bg-white rounded-2xl border border-slate-200 shadow-xl shadow-slate-200/40 overflow-hidden">
                        <div className="px-8 py-6 bg-slate-50/30 border-b border-slate-100 flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] text-slate-400 font-normal uppercase tracking-normal mt-1.5">Update the details for this branch</p>
                            </div>
                        </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
                                ...
                                <div className="md:col-span-12 space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative group">
                                            ...
                                            <input
                                                type="text"
                                                className={`w-full pl-11 pr-4 py-3 bg-slate-50/50 border-slate-200 rounded-xl text-xs font-normal text-slate-700 focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all ${errors.name ? 'border-rose-300 ring-rose-50' : ''}`}
                                                value={data.name}
                                                onChange={e => setData('name', e.target.value)}
                                                required
                                                placeholder="e.g. Headquarters / Doha Central"
                                            />
                                        </div>
                                    ...
                                    <div>
                                        <label className="block text-[10px] font-normal text-slate-400 uppercase tracking-normal mb-2.5">Operational Address</label>
                                        <div className="relative group">
                                            <div className="absolute top-4 left-0 pl-4 flex items-start pointer-events-none">
                                                <MapPinIcon className="w-4 h-4 text-slate-400 group-focus-within:text-primary transition-colors" />
                                            </div>
                                            <textarea
                                                className={`w-full pl-11 pr-4 py-3 bg-slate-50/50 border-slate-200 rounded-xl text-xs font-normal text-slate-700 focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all min-h-[100px] ${errors.address ? 'border-rose-300 ring-rose-50' : ''}`}
                                                value={data.address}
                                ...
                                <div className="md:col-span-12 space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            <label className="block text-[10px] font-normal text-slate-400 uppercase tracking-normal mb-2.5">Operational Email</label>
                                            <div className="relative group">
                                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                                ...
                                                <input
                                                    ...
                                                    placeholder="branch@earthdoha.com"
                                                />
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative group">
                                            ...
                                            <input
                                                ...
                                                placeholder="https://earthdoha.com/branch"
                                            />
                                        </div>
