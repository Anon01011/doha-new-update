...
export default function Create({ companies = [], employees = [], initialCompanyId = null, initialEmployeeId = null, initialWeekStart = null }) {
    ...
    const handleSubmit = (e) => {
        ...
        if (!selectedEmployee || !selectedCompany) {
            setConfirmingAction({
                ...
                message: 'Please select company and employee before submitting.',
                type: 'warning',
                hideCancel: true,
        ...
        if (attendances.length === 0) {
            setConfirmingAction({
                show: true,
                title: 'No Data',
                message: 'Please mark attendance for at least one day before submitting.',
                type: 'warning',
                hideCancel: true,
                onConfirm: () => setConfirmingAction(prev => ({ ...prev, show: false }))
            });
        ...
        post(route('employee-attendances.batchStore'), {
            ...
            onError: (errors) => {
                ...
                setConfirmingAction({
                    ...
                    message: 'Failed to submit attendance. Please check the form and try again.',
                    type: 'danger',
                    hideCancel: true,
                    onConfirm: () => setConfirmingAction(prev => ({ ...prev, show: false }))
                });
            ...
            <div className="bg-white rounded-b-xl shadow p-6 full-w mx-auto mt-0">
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="flex flex-col md:flex-row md:items-end md:space-x-6 space-y-2 md:space-y-0 mb-4">
                        ...
                        <div className="flex flex-col flex-1 min-w-[200px] z-50">
                            ...
                            <SearchableSelect
                                ...
                                options={employees.map(e => ({ value: e.id, label: `${e.name} (${e.employee_code || e.id})` }))}
                    ...
                    <div className="flex justify-end mt-4">
                        <button type="submit" className="bg-primary text-white px-6 py-2 rounded hover:brightness-110 shadow-lg shadow-primary/20 active:scale-95" disabled={processing}>
